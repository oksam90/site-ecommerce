...
//Process From
		if (isset($_POST) && !empty($_POST)) {
			...
			$count = mysqli_fetch_assoc($fresult);
			...
			<tbody>
				...
				while ($parent = mysqli_fetch_assoc($result)) : 
					...
					<tr class="bg-primary">
						...
						<td>Parent</td>
						<td>
							<a href="categories.php?edit=<?=$parent['id']; ?>" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-pencil"></span></a>
